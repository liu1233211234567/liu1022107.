...
public class MessageVerifyUtils {
    ...
    static final String accessKeyId = "LTAI4GJ2m9pXTvR6fiDBvZxA";           // TODO 改这里
    static final String accessKeySecret = "n8yIHGLgtIDC72JiU0yp7f4YqGoGXi"; // TODO 改这里
    ...
    public static SendSmsResponse sendSms(String userPhone, String userCode) throws ClientException {
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("某某商城"); // TODO 改这里
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_195863219");  // TODO 改这里
    ...
    /*public static void main(String[] args) throws Exception {
         ...
         SendSmsResponse sendSms =sendSms("15236284808",code);//填写你需要测试的手机号码
